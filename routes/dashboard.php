...
Route::middleware(['auth', 'role:artisan'])
    ...
    Route::get('/home', [\App\Http\Controllers\Artisan\DashboardController::class, 'index'])->name('index');

    // CONFIGURAR LOJA
    Route::get('/shop', [ShopSettingsController::class, 'settings'])->name('shop.settings');
    ...
    Route::patch('/shop/customization', [ShopCustomizationController::class, 'update'])->name('shop.customization.update');
